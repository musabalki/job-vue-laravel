                ...
                <div class="flex justify-center">
                    ...
                    <div v-if="user" class="relative inline-block ">
                        ...
                        <button @click="toggle()"
                            ...
                            <span class="mx-1">Musa Balkı</span>
                        ...
                        <div :class="user ? null : '' " class=" absolute right-0 z-20 w-60 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800">
                            <a href="#"
                                ...
                                <div class="mx-1">
                                    <h1 class="text-sm font-semibold text-gray-700 dark:text-gray-200">Musa Balkı</h1>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">musabalkimb@gmail.com</p>
                                </div>
                            </a>
